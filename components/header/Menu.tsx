              ...
              <ul className="">
                {
                  ...
                  item.children.map((node) => (
                    <li
                      style={{ height: "fit-content" }}
                      className="flex justify-between pl-[24px] pr-[24px] items-center border-b border-solid border-edgegray"
                      key={node.id}
                    >
                      <MenuItem item={node} />
                      <svg
  ...
  return (
    <div className="flex flex-col h-full px-6">
      ...
      <ul className="flex flex-col mt-6 border border-[#ededed] rounded-[8px]">
        ...
        <li className=" py-3 px-6 text-[11px] uppercase font-bold h-10 items-center border-t border-b border-edgegray">
          <a
